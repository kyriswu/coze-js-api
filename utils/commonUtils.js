...
const commonUtils = {
    MESSAGE: {
        TOKEN_EMPTY: "API_KEY不能为空。可先前往 https://devtool.uk/apikey 查询积分余额，购买密钥请访问 https://devtool.uk/plugin",
        TOKEN_EXPIRED: '令牌无效。可先前往 https://devtool.uk/apikey 查询积分余额；续费或者购买请访问：https://devtool.uk/plugin',
        TOKEN_NO_TIMES: '令牌无可用积分。可先前往 https://devtool.uk/apikey 查询积分余额；续费或者购买请访问：https://devtool.uk/plugin',
        FREE_KEY_EXPIRED_1: "免费版每日仅有 1 积分。可先前往 https://devtool.uk/apikey 查询积分余额，付费可获得更多积分额度： https://devtool.uk/plugin",
        FREE_KEY_EXPIRED_3: "免费版每日仅有 3 积分。可先前往 https://devtool.uk/apikey 查询积分余额，付费可获得更多积分额度： https://devtool.uk/plugin",
        FREE_API_HOUR_USE_LIMIT:"免费版每小时仅有 1 积分。可先前往 https://devtool.uk/apikey 查询积分余额，付费可获得更多积分额度： https://devtool.uk/plugin",
    ...
    i18nMessage:{
        'zh':{
            'TOKEN_EMPTY': 'API_KEY不能为空！可先前往 https://devtool.uk/apikey 查询积分余额；相关咨询、帮助及开通方式见 https://devtool.uk/plugin',
            'TOKEN_EXPIRED': '令牌无效。可先前往 https://devtool.uk/apikey 查询积分余额；续费或者购买请访问：https://devtool.uk/plugin',
            'TOKEN_NO_TIMES': '令牌无可用积分。可先前往 https://devtool.uk/apikey 查询积分余额；续费或者购买请访问：https://devtool.uk/plugin',
            'FREE_KEY_EXPIRED_1': '免费版每日仅有 1 积分。可先前往 https://devtool.uk/apikey 查询积分余额；付费可获得更多积分额度，详情：https://devtool.uk/plugin',
            'FREE_KEY_EXPIRED_3': '免费版每日仅有 3 积分。可先前往 https://devtool.uk/apikey 查询积分余额；付费可获得更多积分额度，详情：https://devtool.uk/plugin',
            'LARK_ACCESS_KEY_ERROR': '获取飞书授权令牌失败。',
            'COZE_WORKFLOW_ERROR': '请核对工作流序号是否填写无误。',
            'SERVER_ERROR': '服务器内部异常，请稍后重试',
            'HELP_LINK': 'https://devtool.uk/plugin',
        ...
        'en':{
            'TOKEN_EMPTY': 'API_KEY cannot be empty. You can check your credit balance first at https://devtool.uk/apikey. For purchase, visit https://devtool.uk/plugin',
            'TOKEN_EXPIRED': 'Token is invalid. You can check your credit balance first at https://devtool.uk/apikey. Please renew or purchase at https://devtool.uk/plugin',
            'TOKEN_NO_TIMES': 'Token has no available credits. You can check your credit balance first at https://devtool.uk/apikey. Please renew or purchase at https://devtool.uk/plugin',
            'FREE_KEY_EXPIRED_1': 'Free version includes 1 credit per day. You can check your balance first at https://devtool.uk/apikey. Please purchase for more credits at https://devtool.uk/plugin',
            'FREE_KEY_EXPIRED_3': 'Free version includes 3 credits per day. You can check your balance first at https://devtool.uk/apikey. Please purchase for more credits at https://devtool.uk/plugin',
