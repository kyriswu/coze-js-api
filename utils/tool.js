...
const tool = {
    request_chromium: async function (url, cookie, xpath, selector, waitUntil) {
        ...
        const chinaDomainList = [
            'tophub.today','qunar.com','zjedu.org','org.cn','news.cn','douyin.com','gz-cmc.com','10jqka.com.cn','sina.com.cn','gov.cn','chinamobile.com','huorong.cn','yixue99.com','xaprtc.com','com.cn'
            // 可继续添加更多域名
        ];
