...
## Seedance Ten-Minute Task Timeouts — 2026-07-17
...
- [x] Add public-address and response-type validation for reference media only.
- [x] Update public documentation and delivery records; run syntax/diff checks and refresh Graphify only.
